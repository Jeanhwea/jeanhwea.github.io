...
** 解释器 jrepl
   ...
   民间开发的 repl，就叫 ~java-repl~, 该工具可以在 [[https://github.com/albertlatacz/java-repl][github]] 中下载 jar 包，然后直
   接执行
   #+BEGIN_SRC sh
...
** 数组
   ...
   #+BEGIN_SRC java :classname App73 :exports code
     class App73 {
       public static void main(String args[]) {
         // int array
...
** equals 与 ~==~ 的区别
   ...
   #+BEGIN_SRC java :classname App198 :exports code
     class App198 {
       public static void main(String args[]) {
         String s1 = "Hello";
         String s2 = "Hello";
...
** 错误和异常
   ...
   #+BEGIN_SRC java :classname App148 :exports code
     class App148 {
   ...
   #+BEGIN_SRC java :classname App166 :exports code
     class App166 {
...
** 正则表达式
   ...
   #+BEGIN_SRC java :classname App232
   ...
   方法
   #+BEGIN_SRC java :classname App482
     import java.util.*;
     import java.util.regex.*;
     class App482 {
       public static void main(String args[]) {
   ...
   #+BEGIN_SRC java :classname App575 :exports code
     import java.util.*;
     import java.util.regex.*;
     class App575 {
       public static void main(String args[]) {
...
** TODO JVM
*** 类加载过程
    [[file:../static/image/2020/03/java-class-loading.png]]
** TODO JDK 常用包
*** ~java.lang~
