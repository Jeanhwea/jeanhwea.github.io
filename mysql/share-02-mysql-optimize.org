...
#+BEGIN_SRC sql
  ...
  select city.* from city, (select * from country where continent = 'Asia') as country where country.code = City.countryCode and country.population > 5000000;

  create view countries_in_asia as select * from country where continent = 'asia'; select * from countries_in_asia where population > 5000000;
#+END_SRC
