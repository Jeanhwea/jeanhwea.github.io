...
* 整体执行流程
1. 执行流程 [[https://dev.mysql.com/doc/dev/mysql-server/8.0.30/PAGE_SQL_EXECUTION.html#sql_query_exec_parsing][SQL Query Execution]]
2. [[https://dev.mysql.com/doc/dev/mysql-server/8.0.30/CODE_PATH_CREATE_TABLE.html][CREATE_TABLE]]
   [[file:../static/image/2023/0209/213258.png]]
3. do_command [[file:log01-group-by-01.txt::T@8: >do_command][=>]]
   - dispatch_command
