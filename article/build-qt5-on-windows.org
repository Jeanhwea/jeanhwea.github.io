...
- Ruby 1.9.3 或更高版本  [[http://rubyinstaller.org/][http://rubyinstaller.org/]]
  ...
  #+BEGIN_SRC bat
    ...
    rem configure -prefix "C:\Qt\Qt5.15.8\msvc2022_32" -shared -release -nomake tests -skip qtwebengine -opensource -confirm-license -platform win32-msvc -msvc-version 2022 -make libs
