...
有关其他平台的具体要求，请参阅以下页面的 "Setting up your machine" 部分 | [[http://wiki.qt.io/Get_The_Source][获取源码]]
...
- Ruby 1.9.3 或更高版本  [[http://rubyinstaller.org/][http://rubyinstaller.org/]]
  ...
  #+BEGIN_SRC bat
    ...
    rem configure -prefix "C:\Qt\Qt5.15.8\msvc2022_x86" -shared -release -nomake tests -skip qtwebengine -opensource -confirm-license -platform win32-msvc -msvc-version 2022 -make libs
