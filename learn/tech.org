...
**** 快速开始
#+BEGIN_SRC sh
  kubectl create deployment web-gateway --image=nginx
  kubectl expose deployment web-gateway --port=80 --type=NodePort
  kubectl scale deployment web-gateway --replicas=4
#+END_SRC
