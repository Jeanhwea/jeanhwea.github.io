...
** 源码研究
1. 专栏 [[https://learn.lianglianglee.com/%E4%B8%93%E6%A0%8F/MySQL%E5%AE%9E%E6%88%9845%E8%AE%B2][MySQL 实战 45 讲]] | [[https://blog.jcole.us/innodb/][On learning InnoDB: A journey to the core]]
2. [[file:mysql-source-code.org][MySQL 源码笔记]]
3. 示例数据库 [[https://dev.mysql.com/doc/employee/en/employees-installation.html][Employees Sample Database]] | [[https://github.com/datacharmer/test_db][Github]]
4. 代码阅读分享
...
2. 编译源代码
   #+BEGIN_SRC sh
     ...
     mkdir out
     cd out
     cmake -DCMAKE_INSTALL_PREFIX=/opt/mysql -DWITH_BOOST=../../boost/boost_1_77_0 -DWITH_DEBUG=1 -DWITH_UNIT_TESTS=0 ..
     # 编译代码
     cd out
     make -j8
     make install
...
#+END_SRC
** 调试命令
找到对应的进程，然后使用 lldb attach 上
#+BEGIN_SRC sh :results output
  ps aux | grep postgres
#+END_SRC

#+RESULTS:
: jinghuihu        83419   0.0  0.0 34130524    652   ??  S    11:07AM   0:00.00 grep postgres
: jinghuihu        82329   0.0  0.2 34313316  36692   ??  Ss   10:51AM   0:00.16 postgres: jinghuihu test01 [local] idle
: jinghuihu        82278   0.0  0.0 34309036   1792   ??  Ss   10:51AM   0:00.00 postgres: logical replication launcher
: jinghuihu        82277   0.0  0.0 34310060   2136   ??  Ss   10:51AM   0:00.01 postgres: autovacuum launcher
: jinghuihu        82276   0.0  0.0 34307820   5152   ??  Ss   10:51AM   0:00.02 postgres: walwriter
: jinghuihu        82275   0.0  0.0 34307820   2212   ??  Ss   10:51AM   0:00.04 postgres: background writer
: jinghuihu        82274   0.0  0.0 34307820   2788   ??  Ss   10:51AM   0:00.01 postgres: checkpointer
: jinghuihu        80299   0.0  0.1 34309108  14920   ??  Ss   10:41AM   0:00.07 /opt/local/pgsql/bin/postgres -D /opt/local/pgsql/data
