...
** Rust
*** 资源链接
1. [X] The Rust Programming Language | [[https://www.bilibili.com/video/BV1K34y1x7F9][BTV]]
2. [ ] Rust by Example | [[https://doc.rust-lang.org/rust-by-example/index.html][link]]
3. [ ] the rust programming language | [[https://rust-book.cs.brown.edu/][link]]
4. [ ] 如何快速掌握新的 crates | [[https://www.bilibili.com/video/BV12K4y1X7qw/][BTV]]
** cargo
创建项目
#+BEGIN_SRC sh
  cargo new myapp
