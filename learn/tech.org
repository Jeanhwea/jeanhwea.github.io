...
2. linux inside [[https://0xax.gitbooks.io/linux-insides/content/Booting/linux-bootstrap-1.html][link]]
3. c/c++ 编写一个操作系统 [[https://samypesse.gitbook.io/how-to-create-an-operating-system/chapter-2][link]]
4. Linux 内核完全注释 [[http://www.oldlinux.org/download/CLK-5.0-WithCover.pdf][book]]
5. James kernel development tutorial [[http://www.jamesmolloy.co.uk/tutorial_html/index.html][link]]
6. Linux 源码在线导读 bootlin [[https://elixir.bootlin.com/linux/0.12/source/kernel/fork.c][link]]
7. Linux Documentation Project Guides [[https://tldp.org/guides.html][TLDP]] | [[https://tldp.org/LDP/khg/HyperNews/get/khg.html][Linux Kernel Hackers' Guide]]
8. rust 操作系统 [[https://rcore.gitbook.io/rust-os-docs/kai-fa-huan-jing-pei-zhi][rust os]] | [[https://github.com/rcore-os/rCore][rCore]]
...
2. 老版本 Linux 研究网站 [[http://www.oldlinux.org/][oldlinux]]

**** CentOS 7 编译 linux 0.11
#+BEGIN_SRC sh
  # as86 ld86
...
1. 安装页面 [[https://www.rust-lang.org/tools/install][link]]
   ...
   #+END_SRC
2. 入门材料 [[https://rust-book.cs.brown.edu/][rust book]]
* 研发效率
** Git
