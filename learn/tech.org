...
TypeScript LSP 服务 | [[https://githubfast.com/typescript-language-server/typescript-language-server][link]]
#+BEGIN_SRC sh
...
#+BEGIN_SRC sh
  git clone https://githubfast.com/Autossh/autossh.git
  cd autossh
  ./configure
  make
  make install
...
** Chrome
1. crx 镜像 https://chrome.pictureknow.com/
** React
*** 参考资料
...
*** React DevTool
#+BEGIN_SRC sh
  git clone https://githubfast.com/facebook/react.git
  yarn
  # 使用下面任意一个进行编译
...
** 前端 UI 组件库
*** Ant Design
Ant Design 官网 [[https://ant-design.antgroup.com/index-cn][link]]
*** Ant Design Pro
1. latest [[https://pro.ant.design/zh-CN/docs/getting-started/][Ant Design Pro]]
2. v4 https://v4-pro.ant.design/docs/layout-cn
#+BEGIN_SRC sh
