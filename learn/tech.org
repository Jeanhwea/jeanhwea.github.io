...
#+BEGIN_SRC sql
  ...
  -- 修改数据文件属性
  alter database datafile '/u01/part01.dbf' authextend off;
  alter database datafile '/u01/part01.dbf' authextend on next 100M maxsize 10G;
#+END_SRC
** 🐬 MySQL
*** 📚 参考资料
...
* 🎓 学习计划
** 制作操作系统
1. c/c++ 编写一个操作系统 [[https://samypesse.gitbook.io/how-to-create-an-operating-system/chapter-2][link]]
2. Linux 内核完全注释 [[http://www.oldlinux.org/download/clk011c-3.0.pdf][book]]
