...
** 制作操作系统
1. os-tutorial
2. c/c++ 编写一个操作系统 [[https://samypesse.gitbook.io/how-to-create-an-operating-system/chapter-2][link]]
3. Linux 内核完全注释 [[http://www.oldlinux.org/download/CLK-5.0-WithCover.pdf][book]]
4. James kernel development tutorial [[http://www.jamesmolloy.co.uk/tutorial_html/index.html][link]]
5. Linux 源码在线导读 bootlin [[https://elixir.bootlin.com/linux/0.12/source/kernel/fork.c][link]]
6. Linux Documentation Project Guides [[https://tldp.org/guides.html][TLDP]] | [[https://tldp.org/LDP/khg/HyperNews/get/khg.html][Linux Kernel Hackers' Guide]]
7. rust 操作系统 [[https://rcore.gitbook.io/rust-os-docs/kai-fa-huan-jing-pei-zhi][rust os]] | [[https://github.com/rcore-os/rCore][rCore]]
** 操作系统实验
