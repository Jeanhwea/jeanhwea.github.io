...
** 创建表
   ...
   #+BEGIN_SRC sql
     CREATE [TEMPORARY] TABLE[ IF NOT EXISTS] [dbname.]tabname (
       -- columns defines
       colname dbtype [NOT NULL | NULL] [DEFAULT DEFAULT_VALUE] [AUTO_INCREMENT] [UNIQUE [KEY] | [PRIMARY] KEY] [COMMENT 'STRING']
     ) [others];
...
** 插入数据
   ...
   #+BEGIN_SRC sql
     INSERT [INTO] tabname colname1, colname2, ... VALUES (value1, value2, ...) [, (value1, value2, ...), ...];
