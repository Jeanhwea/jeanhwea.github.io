...
** 创建表空间
   创建数据表空间
   #+BEGIN_SRC sql
     CREATE TABLESPACE AVIC_P01
       DATAFILE '/u01/app/oracle/oradata/ora11g/avic_p1.dbf'
   ...
   创建临时表空间
   #+BEGIN_SRC sql
     CREATE TEMPORARY TABLESPACE AVIC_T01
       TEMPFILE '/u01/app/oracle/oradata/ora11g/avic_t1.dbf'
